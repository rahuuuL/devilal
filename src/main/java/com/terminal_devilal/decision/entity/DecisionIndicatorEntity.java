...
public class DecisionIndicatorEntity {
    ...
    public String getCode(){return code;} public String getName(){return name;} public String getCategory(){return category;} public String getSubjectType(){return subjectType;} public String getValueType(){return valueType;} public String getUnit(){return unit;} public String getSourceType(){return sourceType;} public String getSourceReference(){return sourceReference;} public Boolean getEnabled(){return enabled;} public BigDecimal getMinValue(){return minValue;} public BigDecimal getMaxValue(){return maxValue;} public String getDescription(){return description;}
    public void update(String name, String category, String subjectType, String valueType, String unit, String sourceType, String sourceReference, BigDecimal minValue, BigDecimal maxValue, String description, Boolean enabled) { this.name=name;this.category=category;this.subjectType=subjectType;this.valueType=valueType;this.unit=unit;this.sourceType=sourceType;this.sourceReference=sourceReference;this.minValue=minValue;this.maxValue=maxValue;this.description=description;if(enabled!=null)this.enabled=enabled;this.updatedAt=LocalDateTime.now(); }
