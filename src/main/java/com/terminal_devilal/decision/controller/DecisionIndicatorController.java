...
public class DecisionIndicatorController {
    ...
    @GetMapping("/{code}/parameters/{parameterCode}") public IndicatorParameterResponse getParameter(@PathVariable String code,@PathVariable String parameterCode){return service.getParameter(code,parameterCode);}
    ...
    @DeleteMapping("/{code}/parameters/{parameterCode}") public ResponseEntity<Void> deleteParameter(@PathVariable String code,@PathVariable String parameterCode){service.deleteParameter(code,parameterCode);return ResponseEntity.noContent().build();}
