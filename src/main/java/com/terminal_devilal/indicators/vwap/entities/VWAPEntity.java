package com.terminal_devilal.indicators.vwap.entities;
...
@Table(name = "vwap", indexes = { @Index(name = "vwap_idx_date", columnList = "date") })
public class VWAPEntity {
	...
	public VWAPEntity(String ticker, LocalDate date, double closePrice, double vwap, double vwapProximity) {
		super();
		this.ticker = ticker;
		this.date = date;
		this.closePrice = closePrice;
